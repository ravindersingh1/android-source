...
class Dog {
	...
	String mColor;
    // Number of times the dog is fed
    int numberOfFeeds = 0;
    //Number of times the dog taken out for a play
    int numberOfPlays =0;
    ...
    public void feed(){
        ...
        if(numberOfFeeds % 3 == 0){
            
            if(getSize().equalsIgnoreCase("tiny")){
                setSize("small");
            }
            ...
            else if(getSize().equalsIgnoreCase("average")){
                setSize("large");
            }
        }
	...
	// ADD YOUR METHOD HERE, NAME MUST MATCH DESCRIPTION
            public void play(){
                ...
                if(numberOfPlays % 6 == 0){
                    
                    if(getSize().equals("large")){
                        setSize("average");
                    }
                       
                   else if(getSize().equals("average")){
                        setSize("small");
                    }
	...
	// ADD YOUR METHOD HERE, NAME MUST MATCH DESCRIPTION
                    public void cutHair(){
                        ...
                        if (getHairLength() > HAIR_CUT_LENGTH){
